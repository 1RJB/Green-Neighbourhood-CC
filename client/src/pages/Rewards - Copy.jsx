...
function Rewards() {
    ...
    const getRewards = () => {
        ...
        console.log("Fetching rewards with URL:", url); // Log the URL for debugging
        http.get(url).then((res) => {
            console.log("Rewards data:", res.data); // Log the response data
            setRewardList(res.data);
        }).catch((error) => {
            console.error("Error fetching rewards:", error); // Log any errors
        });
    };
                                    ...
                                    <Card>
                                        <div className="pages-card-content">
                                            ...
                                            <CardContent>
                                                ...
                                                <Box sx={{ display: 'flex', alignItems: 'left', mt: 1 }} textAlign={'center'} color="text.secondary">
