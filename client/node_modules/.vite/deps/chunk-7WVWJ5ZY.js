...
function useAutocomplete(props) {
  ...
  const ignoreFocus = React39.useRef(false);
  const firstFocus = React39.useRef(true);
  const inputRef = React39.useRef(null);
  const listboxRef = React39.useRef(null);
  const [anchorEl, setAnchorEl] = React39.useState(null);
  const [focusedTag, setFocusedTag] = React39.useState(-1);
  const defaultHighlighted = autoHighlight ? 0 : -1;
  const highlightedIndexRef = React39.useRef(defaultHighlighted);
  ...
  const resetInputValue = React39.useCallback((event, newValue) => {
  ...
  const [inputPristine, setInputPristine] = React39.useState(true);
  ...
  const syncHighlightedIndex = React39.useCallback(() => {
    if (!popupOpen) {
      return;
    }
  ...
  const isTouch = React39.useRef(false);
...
var Badge = React41.forwardRef(function Badge2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime36.jsxs)(Root, _extends({}, rootProps, {
    children: [children2, (0, import_jsx_runtime35.jsx)(BadgeComponent, _extends({}, badgeProps, {
...
function useButton(parameters = {}) {
  ...
  const buttonRef = React42.useRef();
  const [active, setActive] = React42.useState(false);
  const {
    isFocusVisibleRef,
    onFocus: handleFocusVisible,
    onBlur: handleBlurVisible,
...
var Button3 = React43.forwardRef(function Button4(props, forwardedRef) {
  var _slots$root;
  const {
    action,
    children: children2,
...
function useStateChangeDetection(parameters) {
  ...
  const internalPreviousStateRef = React45.useRef(initialState);
  React45.useEffect(() => {
...
function useControllableReducer(parameters) {
  const lastActionRef = React45.useRef(null);
  const {
    reducer,
    initialState,
  ...
  const controlledPropsRef = React45.useRef(controlledProps);
  if (true) {
    React45.useEffect(() => {
      Object.keys(controlledProps).forEach((key) => {
  ...
  const reducerWithControlledState = React45.useCallback((state, action) => {
    lastActionRef.current = action;
    const controlledState = getControlledState(state, controlledProps);
    const newState = reducer(controlledState, action);
    return newState;
  }, [controlledProps, reducer]);
  const [nextState, dispatch] = React45.useReducer(reducerWithControlledState, initialState);
  const dispatchWithContext = React45.useCallback((action) => {
...
function useDropdown(parameters = {}) {
  ...
  const [popupId, setPopupId] = React46.useState("");
  const [triggerElement, setTriggerElement] = React46.useState(null);
  const lastActionType = React46.useRef(null);
  const handleStateChange = React46.useCallback((event, field, value, reason) => {
    if (field === "open") {
      onOpenChange == null || onOpenChange(event, value);
    }
    lastActionType.current = reason;
  }, [onOpenChange]);
  const controlledProps = React46.useMemo(() => openProp !== void 0 ? {
    open: openProp
  } : {}, [openProp]);
...
var FormControlContext2 = React48.createContext(void 0);
if (true) {
...
var FormControl = React49.forwardRef(function FormControl2(props, forwardedRef) {
  var _slots$root;
  const {
    defaultValue,
    children: children2,
...
function useFormControlContext() {
  return React50.useContext(FormControlContext2);
}
...
var Input = React52.forwardRef(function Input2(props, forwardedRef) {
...
var ListContext2 = React55.createContext(null);
if (true) {
...
function useListItem(parameters) {
  ...
  const listContext = React56.useContext(ListContext2);
  if (!listContext) {
  ...
  const createHandleClick = React56.useCallback((externalHandlers) => (event) => {
  ...
  const createHandlePointerOver = React56.useCallback((externalHandlers) => (event) => {
...
var CompoundComponentContext = React57.createContext(null);
if (true) {
...
function useCompoundParent() {
  const [subitems, setSubitems] = React57.useState(/* @__PURE__ */ new Map());
  const subitemKeys = React57.useRef(/* @__PURE__ */ new Set());
  const deregisterItem = React57.useCallback(function deregisterItem2(id) {
  ...
  const registerItem = React57.useCallback(function registerItem2(id, item) {
  ...
  const sortedSubitems = React57.useMemo(() => sortSubitems(subitems), [subitems]);
  const getItemIndex = React57.useCallback(function getItemIndex2(id) {
...
function useMenu(parameters = {}) {
  ...
  const reducerActionContext = React59.useMemo(() => ({
    listboxRef: rootRef
  }), [rootRef]);
  const {
...
var Menu = React67.forwardRef(function Menu2(props, forwardedRef) {
...
function useMenuButton(parameters = {}) {
  ...
  const menuContext = React68.useContext(DropdownContext);
  if (menuContext === null) {
...
var MenuButton = React69.forwardRef(function MenuButton2(props, forwardedRef) {
  const {
    children: children2,
    disabled = false,
    slots = {},
...
function useMenuItem(params) {
  ...
  const itemMetadata = React70.useMemo(() => ({
    disabled,
    id: id != null ? id : "",
    label,
    ref: itemRef
  ...
  const {
    dispatch
  } = (_React$useContext = React70.useContext(DropdownContext)) != null ? _React$useContext : FALLBACK_MENU_CONTEXT2;
  const {
    getRootProps: getListRootProps,
    highlighted
  } = useListItem({
...
function useMenuItemContextStabilizer(id) {
  const listContext = React71.useContext(ListContext2);
  if (!listContext) {
...
var InnerMenuItem = React72.memo(React72.forwardRef(function MenuItem(props, forwardedRef) {
  var _slots$root;
  const {
    children: children2,
    disabled: disabledProp = false,
...
var MenuItem2 = React72.forwardRef(function MenuItem3(props, ref) {
  const {
    id: idProp
  } = props;
  const {
...
function useModal(parameters) {
  ...
  const isTopModal = React73.useCallback(() => manager.isTopModal(getModal()), [manager]);
...
var Modal = React74.forwardRef(function Modal2(props, forwardedRef) {
  var _slots$root;
  const {
    children: children2,
    closeAfterTransition = false,
...
function useNumberInput(parameters) {
  ...
  const handleStateChange = React75.useCallback((event, field, fieldValue, reason) => {
  ...
  const numberInputActionContext = React75.useMemo(() => {
    return {
      min: min3,
      max: max3,
      step,
  ...
  const [state, dispatch] = useControllableReducer({
    ...
    initialState,
    onStateChange: handleStateChange,
    actionContext: React75.useMemo(() => numberInputActionContext, [numberInputActionContext]),
    componentName
  });
  const {
    value,
...
var NumberInput = React76.forwardRef(function NumberInput2(props, forwardedRef) {
...
var OptionGroup = React77.forwardRef(function OptionGroup2(props, forwardedRef) {
  const {
    disabled = false,
    slotProps = {},
    slots = {}
...
function useOption(params) {
  ...
  const id = useId(idParam);
  const optionRef = React78.useRef(null);
  const selectOption = React78.useMemo(() => ({
    disabled,
    label,
    value,
    ref: optionRef,
...
function useOptionContextStabilizer(value) {
  const listContext = React79.useContext(ListContext2);
  if (!listContext) {
  ...
  const localGetItemState = React79.useCallback((itemValue) => {
    if (itemValue !== value) {
  ...
  const localContextValue = React79.useMemo(() => ({
    dispatch,
    getItemState: localGetItemState
  }), [dispatch, localGetItemState]);
  return {
...
var InnerOption = React80.memo(React80.forwardRef(function Option(props, forwardedRef) {
  ...
  const Root = (_slots$root = slots.root) != null ? _slots$root : "li";
  const optionRef = React80.useRef(null);
...
var Option2 = React80.forwardRef(function Option3(props, ref) {
  const {
    value
  } = props;
  const {
...
function useSelect(props) {
  ...
  const contextValue = React81.useMemo(() => _extends({}, listContextValue, compoundComponentContextValue), [listContextValue, compoundComponentContextValue]);
  let selectValue;
  if (props.multiple) {
...
function defaultRenderValue(selectedOptions) {
  ...
  if (Array.isArray(selectedOptions)) {
    return (0, import_jsx_runtime55.jsx)(React83.Fragment, {
...
var Select = React83.forwardRef(function Select2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime56.jsxs)(React83.Fragment, {
...
var Slider = React85.forwardRef(function Slider2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime58.jsxs)(Root, _extends({}, rootProps, {
    children: [(0, import_jsx_runtime57.jsx)(Rail, _extends({}, railProps)), (0, import_jsx_runtime57.jsx)(Track, _extends({}, trackProps)), marks.filter((mark) => mark.value >= min3 && mark.value <= max3).map((mark, index2) => {
      ...
      return (0, import_jsx_runtime58.jsxs)(React85.Fragment, {
...
function useTabs(parameters) {
  ...
  const getTabId = React92.useCallback((tabPanelId) => {
...
function useTabsList(parameters) {
  ...
  const contextValue = React98.useMemo(() => _extends({}, compoundComponentContextValue, listContextValue), [compoundComponentContextValue, listContextValue]);
  return {
    contextValue,
    dispatch,
    getRootProps,
...
function CssAnimation(props) {
  ...
  const hasExited = React103.useRef(true);
  React103.useEffect(() => {
    if (requestedEnter && hasExited.current) {
      hasExited.current = false;
    }
  }, [requestedEnter]);
  const handleAnimationEnd = React103.useCallback((event) => {
...
var CssTransition = React104.forwardRef(function CssTransition2(props, forwardedRef) {
  const {
    children: children2,
    className,
  ...
  const [isEntering, setIsEntering] = React104.useState(false);
  React104.useEffect(() => {
    if (requestedEnter) {
  ...
  const handleTransitionEnd = React104.useCallback((event) => {
...
var InputBase = React105.forwardRef(function InputBase2(inProps, ref) {
  ...
  const {
    current: isControlled
  } = React105.useRef(value != null);
  const inputRef = React105.useRef();
  const handleInputRefWarning = React105.useCallback((instance) => {
    if (true) {
      if (instance && instance.nodeName !== "INPUT" && !instance.focus) {
  ...
  const checkDirty = React105.useCallback((obj) => {
    if (isFilled(obj)) {
      if (onFilled) {
        onFilled();
      }
...
var Input3 = React106.forwardRef(function Input4(inProps, ref) {
...
var OutlinedInput = React109.forwardRef(function OutlinedInput2(inProps, ref) {
  ...
  return (0, import_jsx_runtime80.jsx)(InputBase_default, _extends({
    ...
    renderSuffix: (state) => (0, import_jsx_runtime80.jsx)(NotchedOutlineRoot2, {
      ...
      label: label != null && label !== "" && fcs.required ? _React$Fragment || (_React$Fragment = (0, import_jsx_runtime79.jsxs)(React109.Fragment, {
        children: [label, " ", "*"]
      })) : label,
...
var FormControl3 = React112.forwardRef(function FormControl4(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiFormControl"
  });
  ...
  const [adornedStart, setAdornedStart] = React112.useState(() => {
    ...
    if (children2) {
      React112.Children.forEach(children2, (child) => {
...
var FormHelperText = React113.forwardRef(function FormHelperText2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiFormHelperText"
  });
...
var MenuList = React114.forwardRef(function MenuList2(props, ref) {
  ...
  const listRef = React114.useRef(null);
  const textCriteriaRef = React114.useRef({
    keys: [],
    repeating: true,
  ...
  React114.Children.forEach(children2, (child, index2) => {
  ...
  const items = React114.Children.map(children2, (child, index2) => {
    if (index2 === activeItemIndex) {
      ...
      return React114.cloneElement(child, newChildProps);
    }
    return child;
  });
...
var Backdrop = React115.forwardRef(function Backdrop2(inProps, ref) {
...
var Modal3 = React116.forwardRef(function Modal4(inProps, ref) {
  ...
  return (0, import_jsx_runtime87.jsx)(Portal, {
    ...
    children: (0, import_jsx_runtime88.jsxs)(RootSlot, _extends({}, rootProps, {
      children: [!hideBackdrop && BackdropComponent ? (0, import_jsx_runtime87.jsx)(BackdropSlot, _extends({}, backdropProps)) : null, (0, import_jsx_runtime87.jsx)(FocusTrap, {
        ...
        isEnabled: isTopModal,
        open,
        children: React116.cloneElement(children2, childProps)
      })]
    }))
  });
});
...
var Popover = React117.forwardRef(function Popover2(inProps, ref) {
  ...
  const getAnchorOffset = React117.useCallback(() => {
  ...
  const getTransformOrigin = React117.useCallback((elemRect) => {
    return {
      vertical: getOffsetTop(elemRect, transformOrigin.vertical),
      horizontal: getOffsetLeft(elemRect, transformOrigin.horizontal)
    };
  }, [transformOrigin.horizontal, transformOrigin.vertical]);
  const getPositioningStyle = React117.useCallback((element) => {
    const elemRect = {
  ...
  const [isPositioned, setIsPositioned] = React117.useState(open);
  const setPositioningStyles = React117.useCallback(() => {
  ...
  React117.useImperativeHandle(action, () => open ? {
    updatePosition: () => {
      setPositioningStyles();
    }
...
var Menu3 = React118.forwardRef(function Menu4(inProps, ref) {
  ...
  const menuListActionsRef = React118.useRef(null);
  const handleEntering = (element, isAppearing) => {
  ...
  let activeItemIndex = -1;
  React118.Children.map(children2, (child, index2) => {
...
var NativeSelectInput = React119.forwardRef(function NativeSelectInput2(props, ref) {
  ...
  return (0, import_jsx_runtime92.jsxs)(React119.Fragment, {
...
var Select3 = React122.forwardRef(function Select4(inProps, ref) {
  ...
  return (0, import_jsx_runtime96.jsx)(React122.Fragment, {
...
var TextField = React123.forwardRef(function TextField2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiTextField"
  });
...
@mui/base/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-7WVWJ5ZY.js.map
