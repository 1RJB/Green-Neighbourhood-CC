import {
  ...
  useFormControl,
  useSlotProps
} from "./chunk-74K4KPAC.js";
import {
  createSvgIcon
} from "./chunk-HLMQQZYE.js";
import {
  buildWarning
...
} from "./chunk-AONLBMFX.js";
import {
  shouldForwardProp,
  useMediaQuery,
  useTheme
} from "./chunk-MN33I54H.js";
import {
...
var ClockIcon = createSvgIcon((0, import_jsx_runtime4.jsxs)(React3.Fragment, {
...
var TimeIcon = createSvgIcon((0, import_jsx_runtime4.jsxs)(React3.Fragment, {
  children: [(0, import_jsx_runtime3.jsx)("path", {
    d: "M11.99 2C6.47 2 2 6.48 2 12s4.47 10 9.99 10C17.52 22 22 17.52 22 12S17.52 2 11.99 2zM12 20c-4.42 0-8-3.58-8-8s3.58-8 8-8 8 3.58 8 8-3.58 8-8 8z"
  }), (0, import_jsx_runtime3.jsx)("path", {
    d: "M12.5 7H11v6l5.25 3.15.75-1.23-4.5-2.67z"
...
function useMeridiemMode(date, ampm, onChange, selectionState) {
  ...
  const handleMeridiemChange = React4.useCallback((mode) => {
...
function PickersPopper(inProps) {
  ...
  return (0, import_jsx_runtime5.jsx)(Popper, _extends({}, popperProps, {
    children: ({
      TransitionProps,
      placement: popperPlacement
    }) => (0, import_jsx_runtime5.jsx)(FocusTrap2, _extends({
      open,
      ...
      children: (0, import_jsx_runtime5.jsx)(Transition, _extends({}, TransitionProps, slotProps == null ? void 0 : slotProps.desktopTransition, {
        children: (0, import_jsx_runtime5.jsx)(PickersPopperPaperWrapper, {
...
var usePickerValue = ({
  ...
  } = React10.useRef(inDefaultValue);
  const {
    current: isControlled
  } = React10.useRef(inValue !== void 0);
  if (true) {
    React10.useEffect(() => {
  ...
  const [dateState, setDateState] = React10.useState(() => {
    let initialValue;
    if (inValue !== void 0) {
  ...
  const viewValue = React10.useMemo(() => valueManager.cleanValue(utils, dateState.draft), [utils, valueManager, dateState.draft]);
  const viewResponse = {
    value: viewValue,
...
var PickersLayout = function PickersLayout2(inProps) {
  ...
  return (0, import_jsx_runtime9.jsxs)(PickersLayoutRoot, {
    ...
    children: [isLandscape ? shortcuts : toolbar, isLandscape ? toolbar : shortcuts, (0, import_jsx_runtime10.jsx)(PickersLayoutContentWrapper, {
      ...
      children: wrapperVariant === "desktop" ? (0, import_jsx_runtime9.jsxs)(React16.Fragment, {
        children: [content, tabs]
      }) : (0, import_jsx_runtime9.jsxs)(React16.Fragment, {
    ...
    fieldProps.InputProps = _extends({}, fieldProps.InputProps, {
      ...
      [`${inputAdornmentProps.position}Adornment`]: (0, import_jsx_runtime11.jsx)(InputAdornment, _extends({}, inputAdornmentProps, {
        children: (0, import_jsx_runtime11.jsx)(OpenPickerButton, _extends({}, openPickerButtonProps, {
          children: (0, import_jsx_runtime11.jsx)(OpenPickerIcon, _extends({}, innerSlotProps == null ? void 0 : innerSlotProps.openPickerIcon))
        }))
      }))
    });
  }
...
var useFieldState = (params) => {
  ...
  const localizedDigits = React18.useMemo(() => getLocalizedDigits(utils), [utils]);
  const sectionsValueBoundaries = React18.useMemo(() => getSectionsBoundaries(utils, localizedDigits, timezone), [utils, localizedDigits, timezone]);
  const getSectionsFromValue = React18.useCallback((value, fallbackSections = null) => fieldValueManager.getSectionsFromValue(utils, value, fallbackSections, (date) => buildSectionsFromFormat({
    utils,
    timezone,
    localeText,
    localizedDigits,
...
var useFieldV7TextField = (params) => {
  ...
  const sectionListRef = React20.useRef(null);
  const handleSectionListRef = useForkRef(inSectionListRef, sectionListRef);
  const localeText = useLocaleText();
  const utils = useUtils();
  const id = useId();
  const [focused, setFocused] = React20.useState(false);
  const interactions = React20.useMemo(() => ({
    syncSelectionToDOM: () => {
  ...
  const sectionBoundaries = React20.useMemo(() => {
    ...
    return state.sections.map((section, index) => {
      ...
      return {
        ...
        content: {
          ...
          [parseInt(React20.version, 10) >= 17 ? "enterKeyHint" : "enterkeyhint"]: isEditable ? "next" : void 0,
...
var useFieldV6TextField = (params) => {
  const theme = useTheme();
  const isRTL = theme.direction === "rtl";
  const focusTimeoutRef = React21.useRef();
  const {
    forwardedProps: {
      onFocus,
      onClick,
  ...
  const sections = React21.useMemo(() => addPositionPropertiesToSections(state.sections, localizedDigits, isRTL), [state.sections, localizedDigits, isRTL]);
  ...
  const placeholder = React21.useMemo(() => {
    if (inPlaceholder) {
      return inPlaceholder;
    }
    return fieldValueManager.getV6InputValueFromSections(getSectionsFromValue(valueManager.emptyValue), localizedDigits, isRTL);
  }, [inPlaceholder, fieldValueManager, getSectionsFromValue, valueManager.emptyValue, localizedDigits, isRTL]);
  const valueStr = React21.useMemo(() => state.tempValueStrAndroid ?? fieldValueManager.getV6InputValueFromSections(state.sections, localizedDigits, isRTL), [state.sections, fieldValueManager, state.tempValueStrAndroid, localizedDigits, isRTL]);
  React21.useEffect(() => {
...
var useField = (params) => {
  ...
  const sectionOrder = React22.useMemo(() => getSectionOrder(state.sections, isRTL && !enableAccessibleFieldDOMStructure), [state.sections, isRTL, enableAccessibleFieldDOMStructure]);
  const {
    returnedValue,
    interactions
...
var useMobilePicker = (_ref) => {
  ...
  const utils = useUtils();
  const fieldRef = React25.useRef(null);
  const labelId = useId();
  const isToolbarHidden = ((_a = innerSlotProps == null ? void 0 : innerSlotProps.toolbar) == null ? void 0 : _a.hidden) ?? false;
  const {
    open,
  ...
  const handleFieldRef = useForkRef(fieldRef, fieldProps.unstableFieldRef);
  const renderPicker = () => (0, import_jsx_runtime17.jsxs)(LocalizationProvider, {
    localeText,
    children: [(0, import_jsx_runtime16.jsx)(Field, _extends({}, fieldProps, {
      slots: slotsForField,
      slotProps,
      unstableFieldRef: handleFieldRef
    })), (0, import_jsx_runtime16.jsx)(PickersModalDialog, _extends({}, actions, {
      open,
      slots,
      slotProps,
      children: (0, import_jsx_runtime16.jsx)(Layout, _extends({}, layoutProps, slotProps == null ? void 0 : slotProps.layout, {
        slots,
        slotProps,
        children: renderCurrentView()
      }))
...
var _excluded11 = ["clearable", "onClear", "InputProps", "sx", "slots", "slotProps"];
...
var useClearableField = (props) => {
  ...
  return _extends({}, other, {
    InputProps: _extends({}, InputProps, {
      endAdornment: (0, import_jsx_runtime19.jsxs)(React26.Fragment, {
        children: [clearable && (0, import_jsx_runtime18.jsx)(InputAdornment_default, {
          position: "end",
          sx: {
            marginRight: (InputProps == null ? void 0 : InputProps.endAdornment) ? -1 : -1.5
          },
          children: (0, import_jsx_runtime18.jsx)(IconButton, _extends({}, iconButtonProps, {
            onClick: onClear,
            children: (0, import_jsx_runtime18.jsx)(EndClearIcon, _extends({
              fontSize: "small"
            }, endClearIconProps))
          }))
...
var _excluded12 = ["slots", "slotProps", "elements", "sectionListRef"];
...
function PickersSection(props) {
  ...
  return (0, import_jsx_runtime21.jsxs)(Section, _extends({}, sectionProps, {
...
var PickersSectionList = React27.forwardRef(function PickersSectionList2(inProps, ref) {
  ...
  return (0, import_jsx_runtime20.jsx)(Root, _extends({}, rootProps, {
    children: rootProps.contentEditable ? elements.map(({
      ...
      before,
      after
    }) => `${before.children}${content.children}${after.children}`).join("") : (0, import_jsx_runtime20.jsx)(React27.Fragment, {
...
var _excluded13 = ["elements", "areAllSectionsEmpty", "defaultValue", "label", "value", "onChange", "id", "autoFocus", "endAdornment", "startAdornment", "renderSuffix", "slots", "slotProps", "contentEditable", "tabIndex", "onInput", "onPaste", "onKeyDown", "fullWidth", "name", "readOnly", "inputProps", "inputRef", "sectionListRef"];
...
var PickersInputBase = React28.forwardRef(function PickersInputBase2(inProps, ref) {
  ...
  return (0, import_jsx_runtime23.jsxs)(InputRoot, _extends({}, inputRootProps, {
    children: [startAdornment, (0, import_jsx_runtime22.jsx)(PickersSectionList, {
      sectionListRef,
      elements,
      contentEditable,
      tabIndex,
    ...
    }), endAdornment, renderSuffix ? renderSuffix(_extends({}, muiFormControl)) : null, (0, import_jsx_runtime22.jsx)(PickersInputBaseInput, _extends({
      name,
...
function Outline(props) {
  ...
  return (0, import_jsx_runtime24.jsx)(OutlineRoot, _extends({
    "aria-hidden": true,
    className
  }, other, {
    ownerState,
    children: (0, import_jsx_runtime24.jsx)(OutlineLegend, {
      ownerState,
      children: withLabel ? (0, import_jsx_runtime24.jsx)(OutlineLabel, {
        children: label
      }) : (
        // notranslate needed while Google Translate will not fix zero-width space issue
        (0, import_jsx_runtime24.jsx)(OutlineLabel, {
...
var _excluded15 = ["label", "autoFocus", "ownerState", "notched"];
...
var PickersOutlinedInput = React30.forwardRef(function PickersOutlinedInput2(inProps, ref) {
  ...
  return (0, import_jsx_runtime26.jsx)(PickersInputBase, _extends({
    ...
    renderSuffix: (state) => (0, import_jsx_runtime26.jsx)(Outline, {
      ...
      label: label != null && label !== "" && (muiFormControl == null ? void 0 : muiFormControl.required) ? (0, import_jsx_runtime25.jsxs)(React30.Fragment, {
        children: [label, " ", "*"]
      }) : label,
      ownerState
    })
...
var _excluded18 = ["onFocus", "onBlur", "className", "color", "disabled", "error", "variant", "required", "InputProps", "inputProps", "inputRef", "sectionListRef", "elements", "areAllSectionsEmpty", "onClick", "onKeyDown", "onKeyUp", "onPaste", "onInput", "endAdornment", "startAdornment", "tabIndex", "contentEditable", "focused", "value", "onChange", "fullWidth", "id", "name", "helperText", "FormHelperTextProps", "label", "InputLabelProps"];
...
var PickersTextField = React33.forwardRef(function PickersTextField2(inProps, ref) {
  ...
  return (0, import_jsx_runtime30.jsxs)(PickersTextFieldRoot, _extends({
    className: clsx_default(classes.root, className),
    ref: handleRootRef,
    focused,
    onFocus,
...
//# sourceMappingURL=chunk-VSECUDCE.js.map
