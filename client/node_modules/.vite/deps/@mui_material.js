...
var Slider = React82.forwardRef(function Slider2(inputProps, ref) {
  ...
  return (0, import_jsx_runtime97.jsxs)(RootSlot, _extends({}, rootProps, {
    children: [(0, import_jsx_runtime96.jsx)(RailSlot, _extends({}, railProps)), (0, import_jsx_runtime96.jsx)(TrackSlot, _extends({}, trackProps)), marks.filter((mark) => mark.value >= min && mark.value <= max).map((mark, index) => {
      ...
      return (0, import_jsx_runtime97.jsxs)(React82.Fragment, {
...
var Tooltip = React87.forwardRef(function Tooltip2(inProps, ref) {
  ...
  const children = React87.isValidElement(childrenProp) ? childrenProp : (0, import_jsx_runtime104.jsx)("span", {
    children: childrenProp
  });
  const theme = useTheme();
  const isRtl = useRtl();
  ...
  return (0, import_jsx_runtime105.jsxs)(React87.Fragment, {
    children: [React87.cloneElement(children, childrenProps), (0, import_jsx_runtime104.jsx)(PopperComponent, _extends({
...
var Step = React93.forwardRef(function Step2(inProps, ref) {
  ...
  return (0, import_jsx_runtime112.jsx)(StepContext_default.Provider, {
    value: contextValue,
    children: connector && !alternativeLabel && index !== 0 ? (0, import_jsx_runtime111.jsxs)(React93.Fragment, {
...
var StepButton = React98.forwardRef(function StepButton2(inProps, ref) {
  ...
  const child = isMuiElement_default(children, ["StepLabel"]) ? React98.cloneElement(children, childProps) : (0, import_jsx_runtime119.jsx)(StepLabel_default, _extends({}, childProps, {
    children
  }));
...
var SwipeableDrawer = React103.forwardRef(function SwipeableDrawer2(inProps, ref) {
  ...
  return (0, import_jsx_runtime125.jsxs)(React103.Fragment, {
