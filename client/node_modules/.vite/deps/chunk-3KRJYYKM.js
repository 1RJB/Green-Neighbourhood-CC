...
var useClearableField = (props) => {
  ...
  return _extends({}, other, {
    InputProps: _extends({}, InputProps, {
      endAdornment: (0, import_jsx_runtime4.jsxs)(React3.Fragment, {
...
function PickersSection(props) {
  ...
  return (0, import_jsx_runtime6.jsxs)(Section, _extends({}, sectionProps, {
    children: [(0, import_jsx_runtime5.jsx)(SectionSeparator, _extends({}, sectionSeparatorBeforeProps)), (0, import_jsx_runtime5.jsx)(SectionContent, _extends({}, sectionContentProps)), (0, import_jsx_runtime5.jsx)(SectionSeparator, _extends({}, sectionSeparatorAfterProps))]
  }));
}
var PickersSectionList = React4.forwardRef(function PickersSectionList2(inProps, ref) {
  ...
  return (0, import_jsx_runtime5.jsx)(Root, _extends({}, rootProps, {
    children: rootProps.contentEditable ? elements.map(({
      ...
      before,
      after
    }) => `${before.children}${content.children}${after.children}`).join("") : (0, import_jsx_runtime5.jsx)(React4.Fragment, {
      children: elements.map((element, elementIndex) => (0, import_jsx_runtime5.jsx)(PickersSection, {
        slots,
        slotProps,
        element,
        classes
...
var PickersInputBase = React5.forwardRef(function PickersInputBase2(inProps, ref) {
  ...
  return (0, import_jsx_runtime8.jsxs)(InputRoot, _extends({}, inputRootProps, {
...
function Outline(props) {
  ...
  return (0, import_jsx_runtime9.jsx)(OutlineRoot, _extends({
    "aria-hidden": true,
    className
  }, other, {
    ownerState,
    children: (0, import_jsx_runtime9.jsx)(OutlineLegend, {
      ownerState,
      children: withLabel ? (0, import_jsx_runtime9.jsx)(OutlineLabel, {
        children: label
      }) : (
        // notranslate needed while Google Translate will not fix zero-width space issue
        (0, import_jsx_runtime9.jsx)(OutlineLabel, {
...
var PickersOutlinedInput = React7.forwardRef(function PickersOutlinedInput2(inProps, ref) {
  ...
  return (0, import_jsx_runtime11.jsx)(PickersInputBase, _extends({
    ...
    renderSuffix: (state) => (0, import_jsx_runtime11.jsx)(Outline, {
      shrink: Boolean(notched || state.adornedStart || state.focused || state.filled),
      notched: Boolean(notched || state.adornedStart || state.focused || state.filled),
      className: classes.notchedOutline,
      label: label != null && label !== "" && (muiFormControl == null ? void 0 : muiFormControl.required) ? (0, import_jsx_runtime10.jsxs)(React7.Fragment, {
        children: [label, " ", "*"]
      }) : label,
      ownerState
    })
...
var PickersTextField = React10.forwardRef(function PickersTextField2(inProps, ref) {
  ...
  return (0, import_jsx_runtime15.jsxs)(PickersTextFieldRoot, _extends({
    ...
    children: [(0, import_jsx_runtime14.jsx)(InputLabel_default, _extends({
      htmlFor: id,
      id: inputLabelId
    }, InputLabelProps, {
      children: label
    })), (0, import_jsx_runtime14.jsx)(PickersInputComponent, _extends({
      elements,
      areAllSectionsEmpty,
      onClick,
      onKeyDown,
    ...
    }, InputProps)), helperText && (0, import_jsx_runtime14.jsx)(FormHelperText_default, _extends({
      id: helperTextId
    }, FormHelperTextProps, {
      children: helperText
    }))]
...
var PickersLayout = function PickersLayout2(inProps) {
  ...
  return (0, import_jsx_runtime19.jsxs)(PickersLayoutRoot, {
    ...
    children: [isLandscape ? shortcuts : toolbar, isLandscape ? toolbar : shortcuts, (0, import_jsx_runtime20.jsx)(PickersLayoutContentWrapper, {
      ...
      children: wrapperVariant === "desktop" ? (0, import_jsx_runtime19.jsxs)(React14.Fragment, {
...
init_extends();
var _excluded14 = ["enableAccessibleFieldDOMStructure"];
...
var convertFieldResponseIntoMuiTextFieldProps = (_ref) => {
  let {
    enableAccessibleFieldDOMStructure
  } = _ref, fieldResponse = _objectWithoutPropertiesLoose(_ref, _excluded14);
...
var PickersToolbar = React25.forwardRef(function PickersToolbar2(inProps, ref) {
  ...
  return (0, import_jsx_runtime24.jsxs)(PickersToolbarRoot, _extends({
    ref,
    className: clsx_default(classes.root, className),
    ownerState
  }, other, {
    children: [(0, import_jsx_runtime23.jsx)(Typography_default, {
      color: "text.secondary",
      variant: "overline",
      id: titleId,
      children: toolbarTitle
    }), (0, import_jsx_runtime23.jsx)(PickersToolbarContent, {
...
var PickersPopperPaperWrapper = React26.forwardRef((props, ref) => {
  ...
  return (0, import_jsx_runtime25.jsx)(PaperComponent, _extends({}, other, paperProps, {
    onClick: (event) => {
      var _a;
      onPaperClick(event);
...
function PickersPopper(inProps) {
  ...
  return (0, import_jsx_runtime25.jsx)(Popper, _extends({}, popperProps, {
    children: ({
      TransitionProps,
      placement: popperPlacement
    }) => (0, import_jsx_runtime25.jsx)(FocusTrap2, _extends({
      open,
      ...
      children: (0, import_jsx_runtime25.jsx)(Transition, _extends({}, TransitionProps, slotProps == null ? void 0 : slotProps.desktopTransition, {
        children: (0, import_jsx_runtime25.jsx)(PickersPopperPaperWrapper, {
...
var usePickerViews = ({
  ...
  const {
    hasUIView,
    viewModeLookup
  } = React29.useMemo(() => views.reduce((acc, viewForReduce) => {
    let viewMode;
  ...
  const timeViewsCount = React29.useMemo(() => views.reduce((acc, viewForReduce) => {
  ...
  const [popperView, setPopperView] = React29.useState(currentViewMode === "UI" ? view : null);
...
var useIsLandscape = (views, customOrientation) => {
  const [orientation, setOrientation] = React30.useState(getOrientation);
  useEnhancedEffect_default(() => {
    const eventHandler = () => {
...
function PickersModalDialog(props) {
  ...
  return (0, import_jsx_runtime28.jsx)(Dialog, _extends({
    open,
    onClose: onDismiss
    ...
    children: (0, import_jsx_runtime28.jsx)(PickersModalDialogContent, {
      children
    })
  }));
}
...
var _excluded19 = ["props", "getOpenDialogAriaText"];
var useMobilePicker = (_ref) => {
  ...
  const utils = useUtils();
  const fieldRef = React33.useRef(null);
  const labelId = useId();
  const isToolbarHidden = ((_a = innerSlotProps == null ? void 0 : innerSlotProps.toolbar) == null ? void 0 : _a.hidden) ?? false;
  const {
    open,
  ...
  const renderPicker = () => (0, import_jsx_runtime30.jsxs)(LocalizationProvider, {
    localeText,
    children: [(0, import_jsx_runtime29.jsx)(Field, _extends({}, fieldProps, {
      slots: slotsForField,
      slotProps,
      unstableFieldRef: handleFieldRef
    })), (0, import_jsx_runtime29.jsx)(PickersModalDialog, _extends({}, actions, {
      open,
      slots,
      slotProps,
...
//# sourceMappingURL=chunk-3KRJYYKM.js.map
