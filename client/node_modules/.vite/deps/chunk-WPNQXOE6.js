...
var _excluded2 = ["autoFocus", "children", "disabled", "selected", "value", "tabIndex", "onClick", "onKeyDown", "onFocus", "onBlur", "aria-current", "aria-label", "monthsPerRow"];
...
var PickersMonth = React2.memo(function PickersMonth2(inProps) {
  ...
  return (0, import_jsx_runtime2.jsx)(PickersMonthRoot, _extends({
    ...
    children: (0, import_jsx_runtime2.jsx)(PickersMonthButton, {
      ref,
      disabled,
      type: "button",
      role: "radio",
...
var _excluded3 = ["className", "value", "defaultValue", "referenceDate", "disabled", "disableFuture", "disablePast", "maxDate", "minDate", "onChange", "shouldDisableMonth", "readOnly", "disableHighlightToday", "autoFocus", "onMonthFocus", "hasFocus", "onFocusedViewChange", "monthsPerRow", "timezone", "gridLabelId"];
...
var _excluded4 = ["autoFocus", "className", "children", "disabled", "selected", "value", "tabIndex", "onClick", "onKeyDown", "onFocus", "onBlur", "aria-current", "yearsPerRow"];
...
var PickersYear = React4.memo(function PickersYear2(inProps) {
  ...
  return (0, import_jsx_runtime4.jsx)(PickersYearRoot, _extends({
    ...
    children: (0, import_jsx_runtime4.jsx)(PickersYearButton, {
      ref,
      disabled,
      type: "button",
      role: "radio",
...
var _excluded5 = ["autoFocus", "className", "value", "defaultValue", "referenceDate", "disabled", "disableFuture", "disablePast", "maxDate", "minDate", "onChange", "readOnly", "shouldDisableYear", "disableHighlightToday", "onYearFocus", "hasFocus", "onFocusedViewChange", "yearsPerRow", "timezone", "gridLabelId"];
...
var PickersCalendarHeader = React7.forwardRef(function PickersCalendarHeader2(inProps, ref) {
  ...
  return (0, import_jsx_runtime8.jsxs)(PickersCalendarHeaderRoot, _extends({}, other, {
    ownerState,
    className: clsx_default(className, classes.root),
    ref,
    children: [(0, import_jsx_runtime8.jsxs)(PickersCalendarHeaderLabelContainer, {
      role: "presentation",
...
var DateCalendar = React12.forwardRef(function DateCalendar2(inProps, ref) {
  ...
  return (0, import_jsx_runtime13.jsxs)(DateCalendarRoot, _extends({
    ref,
    className: clsx_default(classes.root, className),
    ownerState
  }, other, {
    children: [(0, import_jsx_runtime12.jsx)(CalendarHeader, _extends({}, calendarHeaderProps)), (0, import_jsx_runtime12.jsx)(DateCalendarViewTransitionContainer, {
      reduceAnimations,
...
var renderDateViewCalendar = ({
  ...
  displayWeekNumber,
  timezone
}) => (0, import_jsx_runtime14.jsx)(DateCalendar, {
  view,
  onViewChange,
...
//# sourceMappingURL=chunk-WPNQXOE6.js.map
