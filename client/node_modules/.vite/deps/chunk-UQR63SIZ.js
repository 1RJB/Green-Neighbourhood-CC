import {
  ...
  useFormControl,
  useSlotProps
} from "./chunk-DBPGWEAT.js";
import {
  createSvgIcon
} from "./chunk-ATA7RMF3.js";
import {
  buildWarning
...
} from "./chunk-W3HBVYYC.js";
import {
  shouldForwardProp,
  useMediaQuery,
  useRtl
} from "./chunk-E3YFFYM4.js";
import {
  capitalize,
  composeClasses,
...
} from "./chunk-LZE26CHF.js";
import {
  _objectWithoutPropertiesLoose,
  require_prop_types
} from "./chunk-OWFXNNYS.js";
import {
  clsx_default
...
var usePickerValue = ({
  ...
  } = React10.useRef(inValueWithoutRenderTimezone !== void 0);
  if (true) {
    React10.useEffect(() => {
...
var _excluded9 = ["children", "className", "slots", "slotProps", "isNextDisabled", "isNextHidden", "onGoToNext", "nextLabel", "isPreviousDisabled", "isPreviousHidden", "onGoToPrevious", "previousLabel", "labelId"];
...
var useMobilePicker = (_ref) => {
  ...
  const handleFieldRef = useForkRef(fieldRef, fieldProps.unstableFieldRef);
  const renderPicker = () => (0, import_jsx_runtime11.jsxs)(LocalizationProvider, {
    localeText,
...
var useClearableField = (props) => {
  ...
  return _extends({}, other, {
    InputProps: _extends({}, InputProps, {
      endAdornment: (0, import_jsx_runtime12.jsxs)(React26.Fragment, {
...
var PickersSectionList = React27.forwardRef(function PickersSectionList2(inProps, ref) {
  ...
  return (0, import_jsx_runtime13.jsx)(Root, _extends({}, rootProps, {
    children: rootProps.contentEditable ? elements.map(({
      ...
      before,
      after
    }) => `${before.children}${content.children}${after.children}`).join("") : (0, import_jsx_runtime13.jsx)(React27.Fragment, {
...
var PickersOutlinedInput = React30.forwardRef(function PickersOutlinedInput2(inProps, ref) {
  ...
  return (0, import_jsx_runtime16.jsx)(PickersInputBase, _extends({
    ...
    renderSuffix: (state) => (0, import_jsx_runtime16.jsx)(Outline, {
      ...
      label: label != null && label !== "" && (muiFormControl == null ? void 0 : muiFormControl.required) ? (0, import_jsx_runtime16.jsxs)(React30.Fragment, {
        children: [label, " ", "*"]
      }) : label,
      ownerState
    })
...
//# sourceMappingURL=chunk-UQR63SIZ.js.map
